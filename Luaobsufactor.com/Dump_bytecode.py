...
def main():
    parser = argparse.ArgumentParser(description="Luau bytecode dumper")
    
    parser.add_argument("-i", "-input", dest="input", help="Input Luau file")
    parser.add_argument("-o", "-output", dest="output", help="Output luauc file")
